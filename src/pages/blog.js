                        ...
                        <div className="blog-container1">
                            <div className="blog-text-container1">
                                ...
                                <div className="blog-image-container1">
                                        ...
                                        <StaticImage src={weddingCeremony} alt="A sign pointing wedding guests to a wedding ceremony" placeholder="blurred"/>
                                </div>   
                                ...
                                <div className="blog-image-container2">
                                        ...
                                        <StaticImage src={weddingBouqet} alt="A bride holding pink flowers" placeholder="blurred" />
                                </div>
                            </div>
                        </div>
                    </section>
